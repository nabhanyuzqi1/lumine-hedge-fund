...
input string  InpSeedSymbols = "BTCUSD";
...
int HttpPostJson(const string path, const string json, const int timeoutMs)
  {
   ...
   char result[];
      ...
      // 23 Aug 2026: instance crypto — query param agar proxy routing ke mt5crypto:*
      // (Caddy tidak bisa tambah header/query ke upstream, jadi EA yang set sendiri)
      string url = g_proxyURL + path + "?instance=crypto";
