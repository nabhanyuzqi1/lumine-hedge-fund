...
_SUB_ROLE = "technical_analyst"


async def run_technical_analyst(  # noqa: PLR0913 — analyst stage contract is fixed
    *,
    gateway: Gateway,
    registry: Registry,
    ...
    """Run the Technical Analyst stage (D4-2)."""
