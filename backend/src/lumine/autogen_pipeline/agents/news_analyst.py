...
_SUB_ROLE = "news_analyst"


async def run_news_analyst(  # noqa: PLR0913 — analyst stage contract is fixed
    *,
    gateway: Gateway,
    registry: Registry,
    ...
    """Run the News Analyst stage (D4-2)."""
