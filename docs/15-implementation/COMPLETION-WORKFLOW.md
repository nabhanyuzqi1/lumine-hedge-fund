...
- **Progress 2026-08-14 (lanjutan):** W1 ✅ (B-01..B-07, suite 679 pass) · W2 ✅ (F-01..F-12, 169 tests) · W3 ✅ (stack docker 6/6 healthy, E2E 16/16) · W4 ✅ v1 **LIVE http://166.88.227.177/** (6 service, key web-frontend, 8/8 smoke, DR test pass, bandit 0 High, mt5-wine build); sisa: HTTPS (butuh domain), 9router (butuh API key), login MT5 via noVNC, CI/CD, seed produksi
