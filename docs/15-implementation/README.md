...
| Frontend | `docs/10-frontend/`, `docs/15-implementation/frontend-sprint-plan.md` | `frontend/src/` scaffolded; F-Sprint 1–5 Done (router, design system, realtime layer, charts, surfaces); F-Sprint 6 pending | Partial |
...
| Sprint 6 — Frontend | F-Sprint 1–5 Done (scaffold, design system, realtime, charts, surfaces); F-Sprint 6 in progress (keyboard, responsive, a11y, performance) | In Progress |
